        ...
        slivers: [
          ...
          if (searching) ...[
            ...
            if (recents.isNotEmpty)
              SliverToBoxAdapter(
                child: _RecentFilesSection(recents: recents.take(6).toList()),
              ),
            SliverToBoxAdapter(
              child: Padding(
          ...
          SliverToBoxAdapter(child: SizedBox(height: widget.bottomPadding + 8)),
        ],
      ),
    );
  }
...
class _EntryTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tags = [?collectionName, if (entry.isFavorite) 'Favorite'];
